export const dict = {
  ...
  "titlebar.debugTools.toggle": "Превключване на инструментите за отстраняване на грешки",
  "common.cancel": "Отказ",
  "common.clear": "ясно",
  ...
  "session.attachment.openInApp": "Отваряне в приложението",
  "session.attachment.download": "Изтегляне",
