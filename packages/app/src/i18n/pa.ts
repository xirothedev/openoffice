export const dict = {
  ...
  "titlebar.debugTools.toggle": "ڈیبگ ٹولز ٹوگل کرو",
  ...
  "prompt.toast.attachmentTooLarge.title": "ایہہ فائل 10 MiB منسلکہ حد توں وڈی اے",
  ...
  "session.attachment.openInApp": "ایپ وچ کھولو",
  "session.attachment.download": "ڈاؤن لوڈ کرو",
