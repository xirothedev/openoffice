export const dict = {
  ...
  "prompt.toast.attachmentTooLarge.title": "Ce fichier dépasse la limite de 10 Mio pour les pièces jointes",
  ...
  "session.attachment.openInApp": "Ouvrir dans l'application",
