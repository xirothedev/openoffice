export const dict = {
  ...
  "titlebar.debugTools.toggle": "ڈیبگ ٹولز دکھائیں یا چھپائیں",
  ...
  "prompt.toast.attachmentTooLarge.title": "یہ فائل 10 MiB کی منسلکہ حد سے بڑی ہے",
  ...
  "session.attachment.download": "ڈاؤن لوڈ کریں",
