export const dict = {
  ...
  "titlebar.debugTools.toggle": "Mostra o nascondi gli strumenti di debug",
  ...
  "prompt.toast.attachmentTooLarge.title": "Questo file supera il limite di 10 MiB per gli allegati",
