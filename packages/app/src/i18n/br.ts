export const dict = {
  ...
  "titlebar.debugTools.toggle": "Alternar ferramentas de depuração",
  ...
  "prompt.toast.attachmentTooLarge.title": "Este arquivo é maior que o limite de anexo de 10 MiB",
  ...
  "session.attachment.openInApp": "Abrir no aplicativo",
  "session.attachment.download": "Baixar",
