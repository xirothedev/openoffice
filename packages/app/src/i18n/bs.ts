export const dict = {
  ...
  "titlebar.debugTools.toggle": "Prikaži/sakrij alate za otklanjanje grešaka",
  ...
  "prompt.toast.attachmentTooLarge.title": "Ova datoteka je veća od ograničenja priloga od 10 MiB",
