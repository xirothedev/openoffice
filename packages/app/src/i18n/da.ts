export const dict = {
  ...
  "titlebar.debugTools.toggle": "Skift fejlfindingsværktøjer",
  ...
  "prompt.toast.attachmentTooLarge.title": "Denne fil er større end grænsen for vedhæftning på 10 MiB",
  ...
  "session.attachment.openInApp": "Åbn i app",
