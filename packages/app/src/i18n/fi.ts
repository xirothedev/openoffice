export const dict = {
  ...
  "titlebar.debugTools.toggle": "Näytä tai piilota virheenkorjaustyökalut",
  ...
  "prompt.toast.attachmentTooLarge.title": "Tämä tiedosto on suurempi kuin 10 MiB:n liiterajoitus",
