export const dict = {
  ...
  "titlebar.debugTools.toggle": "Växla felsökningsverktyg",
  ...
  "prompt.toast.attachmentTooLarge.title": "Den här filen är större än bilagegränsen på 10 MiB",
  ...
  "session.attachment.download": "Ladda ned",
